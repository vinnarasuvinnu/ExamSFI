...
if(!isset($_SESSION['uid'])){
  echo '<script>';
  echo 'alert("please do register to proceed with login");location.href="fin.php"';
  echo '</script>';
}
...
<body>
  ...
  <div class="form">
    <form class="login-form" action="login_b.php" method="POST">
      <img src="img/logo.png" style="width: 50%"><br><br>
      <input type="text" placeholder="passcode" name="pass" />
